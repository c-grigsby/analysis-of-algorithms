...
#   return -1                                             // not found
#
# Notes: This algorithm utilizes logic for merge as shown in Module 2 https://canvas.oregonstate.edu/courses/1878197/pages/exploration-divide-and-conquer-algorithms?module_item_id=22307095 
# Based on the description provided, the element in position 0 of the array would be the 1st element
